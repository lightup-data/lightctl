...
class SourceClient(BaseClient):
    ...
    def get_source(self, workspace_id: str, id: str) -> Dict:
        url = urllib.parse.urljoin(self.sources_url(workspace_id), id)
        return self.get(url)
    ...
    def update_source(self, workspace_id: str, id, data: Dict) -> Dict:
        url = urllib.parse.urljoin(self.sources_url(workspace_id), id)
        return self.put(url, data)

    def delete_source(self, workspace_id: str, id: str) -> Dict:
        self.delete(self.sources_url(workspace_id), id)
    ...
    def list_tables(self, workspace_id: str, id: str) -> List[Dict]:
        url = urllib.parse.urljoin(
    ...
    def get_schema(self, workspace_id: str, id: str, table_name: str) -> Dict:
        url = urllib.parse.urljoin(
    ...
    def update_profiler_config(
        self, workspace_id: str, id: str, table_uuid: str, data: Dict
    ) -> Dict:
        url = urllib.parse.urljoin(
            self.sources_url(workspace_id),
    ...
    def trigger_source(self, workspace_id: str, id: str) -> Dict:
